export const ja = {
  ...
  platform: {
    ...
    stock: {
      ...
      newsEmpty: "関連ニュースがありません。",
      summaryLabel: "AI要約",
      summaryLoading: "AI要約を生成中...",
      summaryError: "AI要約の取得に失敗しました。",
      summaryCached: "キャッシュ",
      bullLabel: "Bull Case",
      bearLabel: "Bear Case",
      keyRisksLabel: "Key Risks",
      whatToWatchLabel: "What to Watch",
      generatedAtLabel: "生成日時",
      summaryDisclaimer:
        "AI生成の参考情報です。投資判断はご自身の責任で行ってください。",
      notFound: "銘柄が見つかりません。",
    },
  },
  api: {
    ...
    finnhub: {
      ...
      newsFailed: "ニュースの取得に失敗しました。",
    },
    ai: {
      notConfigured: "OpenAI API が設定されていません。",
      summaryFailed: "AI要約の生成に失敗しました。",
    },
  },
} as const;
